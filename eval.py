...
def run(dataloader, dataset, imp_site_info_list, model_config, args, region):
    ...
    # write_gen(predictions, dosage, imp_site_info_list, chromosome, region, result_gen_dir)
    # write_gen(labels, labels.T, imp_site_info_list, chromosome, region, result_gen_dir, ground_truth=True)
    write_dosage(dosage, imp_site_info_list, chromosome, region, result_gen_dir)
    # write_dosage(labels.T, imp_site_info_list, chromosome, region, result_gen_dir, ground_truth=True)
